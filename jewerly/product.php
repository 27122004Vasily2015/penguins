...
<body>
    ...
    <nav class="link__nav">
        <ul class="link__nav_ul">
            <li><a href="">Главная /</a></li>
            <li><a href="">Каталог /</a></li>
            <li><a href="">Категория /</a></li>
            <li><a href="">Подвеска Dolce & Gabarra</a></li>
        </ul>
    </nav>

    <section class="about_product">
        <div class="about_product_img">
            <img src="images/big-prod.png" alt="" class="prod_img">
            <img src="images/min-prod.png" alt="" class="prod_img2">
            <img src="images/min-prod.png" alt="" class="prod_img2">
            <img src="images/min-prod.png" alt="" class="prod_img2">
        </div>
        ...
        <div class="about_product_block">
            <div class="about_product__text">
                <div class="about_product__text_in">
                    ...
                    <h2 class="prod_price">200 000 ₽ </h2>

                    <div class="prod_btns">
                        <button class="buy_btn">купить</button>
                        <button class="cart_btn">добавить в корзину</button>
                    </div>
                </div>
            </div>
    ...
    <section class="delivery">
        ...
        <div class="delivery_icons">
            ...
            <div class="delivery_icons_card">
                <img src="imgaes/icons/delivery-icons (4).png" alt="">
                <p>Индивидуальный
                    дизайн</p>
            </div>
