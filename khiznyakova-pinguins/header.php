...
<body> 
    <header> 
        <div class="nav-header"> 
            <h2><a href="admin/index.php">MENU</a></h2> 
            ...
            <div class="vhod">
            <?php if ($username) { ?>
                <a href="/Sign/page.php" class="pers-name"><?= $username ?></a>
            <?php } ?>
                <?php if(!isset($_SESSION["user"])) { ?>
                    <a href="sign/auth.php">Вход</a>/<a href="sign/reg.php">Регистрация</a>
                <?php } else { ?>
                    <a href="sign/signout.php">Выход</a>
                <?php } ?>
            </div>
